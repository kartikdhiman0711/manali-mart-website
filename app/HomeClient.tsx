      ...
      <section className="py-16 bg-green-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <a href="https://wa.me/916230335333?text=Hello%20%F0%9F%91%8B%0AI%20would%20like%20to%20place%20an%20order%20%F0%9F%9B%8D%EF%B8%8F%0APlease%20assist%20%F0%9F%99%8F" target="_blank" rel="noopener noreferrer" className="bg-white bg-opacity-10 hover:bg-opacity-20 backdrop-blur-sm rounded-lg p-8 text-center transition-all group">
              <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
